...
<body>
    ...
    <div class="container-fluid">
        <div class="row mb-3">
            <h1 class="text-center display-1 title">strelené kačice</h1>
        </div>
    ...
    <div class="row mb-3">
        <div class="col text-center">
            <button class="btn btn-custom-primary btn-lg">začať hru</button>
        </div>
    </div>
    <div class="row mb-3">
        <div class="col text-center">
            <button class="btn btn-custom-secondary btn-sm">prihlásenie</button>
        </div>
    </div>
    </div>
